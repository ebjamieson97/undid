...
* ---------------------------------------------- *
* Step 3: Load in silo data and try variations of undid_plot
...
undid_plot, dir_path("test_csv_files\stage_three\staggered\") plot("silo") event_window(-7 7) covariates(1)