...
{phang}
{cmd:create_diff_df} Creates the CSV file to be sent out to each silo (`empty_diff_df.csv`) and displays its filepath
...
{pstd}
{cmd:create_diff_df} init_filepath(string) date_format(string) freq(string) [{it:covariates(string)} {it:freq_multiplier(int)} {it:weights(string)} {it:filename(string)} {it:filepath(string)}]{p_end}

{title:Examples}

{phang2}{cmd:create_diff_df, filepath("C:/Users/User/Documents/Project Files/init.csv") date_format("yyyy") freq("year")}
